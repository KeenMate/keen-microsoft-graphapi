# GraphApi — Elixir Client for Microsoft Graph API

Built with [Req](https://hexdocs.pm/req) for modern HTTP handling, featuring automatic token management, OData query building, stream-based pagination, batch requests, delta queries, and typed schema casting.
...
This repository is organized as a poncho layout with two sibling Mix projects:

| Directory | Description |
|---|---|
| [`microsoft_graphapi/`](microsoft_graphapi/) | The library |
| [`demo/`](demo/) | Demo app — Phoenix LiveView explorer + programmatic examples |

### Demo — Graph Explorer (web UI)
...
MIT — see [`microsoft_graphapi/LICENSE`](microsoft_graphapi/LICENSE) for details.
