...
defmodule GraphApi.Schema.Beta.Application do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          web: GraphApi.Schema.Beta.WebApplication.t() | nil
        }
  ...
  def from_map(map) when is_map(map) do
    %__MODULE__{
      ...
      web:
        case map["web"] do
          nil -> nil
          val -> GraphApi.Schema.Beta.WebApplication.from_map(val)
        end
    }
  end
  ...
  def to_map(%__MODULE__{} = struct) do
    [
      ...
      {"web",
       case struct.web do
         nil -> nil
         val -> GraphApi.Schema.Beta.WebApplication.to_map(val)
       end}
    ]
