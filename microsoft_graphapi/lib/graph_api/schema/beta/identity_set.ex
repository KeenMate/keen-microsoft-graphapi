...
defmodule GraphApi.Schema.Beta.IdentitySet do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          application: GraphApi.Schema.Beta.Identity.t() | nil,
          device: GraphApi.Schema.Beta.Identity.t() | nil,
          user: GraphApi.Schema.Beta.Identity.t() | nil
        }
    ...
    %__MODULE__{
      application:
        case map["application"] do
          nil -> nil
          val -> GraphApi.Schema.Beta.Identity.from_map(val)
        end,
      device:
        case map["device"] do
          nil -> nil
    ...
    [
      {"application",
       case struct.application do
         nil -> nil
         val -> GraphApi.Schema.Beta.Identity.to_map(val)
       end},
      {"device",
