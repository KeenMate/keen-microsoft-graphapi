defmodule GraphApi.Schema.Beta.UserTest do
  use ExUnit.Case, async: true

  alias GraphApi.Schema.Beta.User
  alias GraphApi.Schema.Beta.PasswordProfile
  ...
  describe "view works with beta schema" do
    defmodule BetaUserSummary do
      use GraphApi.View,
        schema: GraphApi.Schema.Beta.User,
    ...
    test "view __schema__ returns beta module" do
      assert BetaUserSummary.__schema__() == GraphApi.Schema.Beta.User
    end
  end
end
