defmodule GraphApi.Auth.DelegatedTest do
  ...
  describe "exchange_code/1" do
    ...
    test "returns error for invalid code", %{plug: plug} do
      ...
      assert {:error, %GraphApi.Error.AuthError{} = err} = result
  ...
  describe "refresh_token/1" do
    ...
    test "returns error for expired refresh token", %{plug: plug} do
      ...
      assert {:error, %GraphApi.Error.AuthError{error: "invalid_grant"}} = result
    end
  end
