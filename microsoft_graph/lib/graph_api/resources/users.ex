defmodule GraphApi.Users do
  ...
  * `:as` - Schema or view module to cast each result
  ...
  def list_app_role_assignments(user_id, opts \\ []), do: Resource.execute(list_app_role_assignments_query(user_id, opts), opts)
  ...
  def list_app_role_assignments_query(user_id, opts \\ []), do: build_query("GET", "/users/#{encode(user_id)}/appRoleAssignments", nil, opts)

  @doc """
  Adds an app role assignment to a user.
  """
  @spec add_app_role_assignment(String.t(), map(), keyword()) :: {:ok, map()} | {:error, term()}
  def add_app_role_assignment(user_id, attrs, opts \\ []), do: Resource.execute(add_app_role_assignment_query(user_id, attrs, opts), opts)
  ...
  def add_app_role_assignment_query(user_id, attrs, opts \\ []), do: build_query("POST", "/users/#{encode(user_id)}/appRoleAssignments", attrs, opts)

  @doc """
  Removes an app role assignment from a user.
  """
  @spec remove_app_role_assignment(String.t(), String.t(), keyword()) :: :ok | {:error, term()}
  def remove_app_role_assignment(user_id, assignment_id, opts \\ []), do: Resource.execute(remove_app_role_assignment_query(user_id, assignment_id, opts), opts)
  ...
  def remove_app_role_assignment_query(user_id, assignment_id, opts \\ []), do: build_query("DELETE", "/users/#{encode(user_id)}/appRoleAssignments/#{encode(assignment_id)}", nil, opts)
  ...
  """
  @spec list_oauth2_permission_grants(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  def list_oauth2_permission_grants(user_id, opts \\ []), do: Resource.execute(list_oauth2_permission_grants_query(user_id, opts), opts)

  @doc "Batch query variant of `list_oauth2_permission_grants/2`."
  @spec list_oauth2_permission_grants_query(String.t(), keyword()) :: Batch.Request.t()
  def list_oauth2_permission_grants_query(user_id, opts \\ []), do: build_query("GET", "/users/#{encode(user_id)}/oauth2PermissionGrants", nil, opts)
  ...
  def export_personal_data(user_id, attrs, opts \\ []), do: Resource.execute(export_personal_data_query(user_id, attrs, opts), opts)

  @doc "Batch query variant of `export_personal_data/3`."
  @spec export_personal_data_query(String.t(), map(), keyword()) :: Batch.Request.t()
  def export_personal_data_query(user_id, attrs, opts \\ []), do: build_query("POST", "/users/#{encode(user_id)}/exportPersonalData", attrs, opts)
  ...
  """
  @spec list_license_details(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  def list_license_details(user_id, opts \\ []), do: Resource.execute(list_license_details_query(user_id, opts), opts)

  @doc "Batch query variant of `list_license_details/2`."
  @spec list_license_details_query(String.t(), keyword()) :: Batch.Request.t()
  def list_license_details_query(user_id, opts \\ []), do: build_query("GET", "/users/#{encode(user_id)}/licenseDetails", nil, opts)

  # ---------------------------------------------------------------------------
  # Directory Membership Checks
  # ---------------------------------------------------------------------------
  ...
  def get_member_objects(user_id, attrs, opts \\ []), do: Resource.execute(get_member_objects_query(user_id, attrs, opts), opts)

  @doc "Batch query variant of `get_member_objects/3`."
  @spec get_member_objects_query(String.t(), map(), keyword()) :: Batch.Request.t()
  def get_member_objects_query(user_id, attrs, opts \\ []), do: build_query("POST", "/users/#{encode(user_id)}/getMemberObjects", attrs, opts)

  @doc """
  Returns all group IDs that a user is a member of (transitive).
  """
  @spec get_member_groups(String.t(), map(), keyword()) :: {:ok, map()} | {:error, term()}
  def get_member_groups(user_id, attrs, opts \\ []), do: Resource.execute(get_member_groups_query(user_id, attrs, opts), opts)

  @doc "Batch query variant of `get_member_groups/3`."
  @spec get_member_groups_query(String.t(), map(), keyword()) :: Batch.Request.t()
  def get_member_groups_query(user_id, attrs, opts \\ []), do: build_query("POST", "/users/#{encode(user_id)}/getMemberGroups", attrs, opts)
  ...
  def check_member_objects(user_id, attrs, opts \\ []), do: Resource.execute(check_member_objects_query(user_id, attrs, opts), opts)

  @doc "Batch query variant of `check_member_objects/3`."
  @spec check_member_objects_query(String.t(), map(), keyword()) :: Batch.Request.t()
  def check_member_objects_query(user_id, attrs, opts \\ []), do: build_query("POST", "/users/#{encode(user_id)}/checkMemberObjects", attrs, opts)

  @doc """
  Checks membership in a list of group IDs.
  """
  @spec check_member_groups(String.t(), map(), keyword()) :: {:ok, map()} | {:error, term()}
  def check_member_groups(user_id, attrs, opts \\ []), do: Resource.execute(check_member_groups_query(user_id, attrs, opts), opts)

  @doc "Batch query variant of `check_member_groups/3`."
  @spec check_member_groups_query(String.t(), map(), keyword()) :: Batch.Request.t()
  def check_member_groups_query(user_id, attrs, opts \\ []), do: build_query("POST", "/users/#{encode(user_id)}/checkMemberGroups", attrs, opts)

  # ---------------------------------------------------------------------------
  # Scoped Role Memberships
  # ---------------------------------------------------------------------------

  @doc """
  Lists scoped-role memberships for a user.
  """
  @spec list_scoped_role_member_of(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  def list_scoped_role_member_of(user_id, opts \\ []), do: Resource.execute(list_scoped_role_member_of_query(user_id, opts), opts)

  @doc "Batch query variant of `list_scoped_role_member_of/2`."
  @spec list_scoped_role_member_of_query(String.t(), keyword()) :: Batch.Request.t()
  def list_scoped_role_member_of_query(user_id, opts \\ []), do: build_query("GET", "/users/#{encode(user_id)}/scopedRoleMemberOf", nil, opts)
  ...
  """
  @spec list_authentication_methods(String.t(), keyword()) :: {:ok, map()} | {:error, term()}
  def list_authentication_methods(user_id, opts \\ []), do: Resource.execute(list_authentication_methods_query(user_id, opts), opts)

  @doc "Batch query variant of `list_authentication_methods/2`."
  @spec list_authentication_methods_query(String.t(), keyword()) :: Batch.Request.t()
  def list_authentication_methods_query(user_id, opts \\ []), do: build_query("GET", "/users/#{encode(user_id)}/authentication/methods", nil, opts)
