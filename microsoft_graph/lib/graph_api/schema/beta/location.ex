...
defmodule GraphApi.Schema.Beta.Location do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          address: GraphApi.Schema.Beta.PhysicalAddress.t() | nil
        }
  ...
  def from_map(map) when is_map(map) do
    %__MODULE__{
      ...
      address:
        case map["address"] do
          nil -> nil
          val -> GraphApi.Schema.Beta.PhysicalAddress.from_map(val)
        end
    }
  end
    ...
    [
      ...
      {"address",
       case struct.address do
         nil -> nil
         val -> GraphApi.Schema.Beta.PhysicalAddress.to_map(val)
       end}
    ]
