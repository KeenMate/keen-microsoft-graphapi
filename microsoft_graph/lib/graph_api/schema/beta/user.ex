...
defmodule GraphApi.Schema.Beta.User do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          assigned_licenses: [GraphApi.Schema.Beta.AssignedLicense.t()] | nil,
          password_profile: GraphApi.Schema.Beta.PasswordProfile.t() | nil,
    ...
    %__MODULE__{
      ...
      assigned_licenses:
        case map["assignedLicenses"] do
          nil -> nil
          items -> Enum.map(items, &GraphApi.Schema.Beta.AssignedLicense.from_map/1)
        end,
      password_profile:
        case map["passwordProfile"] do
          nil -> nil
          val -> GraphApi.Schema.Beta.PasswordProfile.from_map(val)
        end,
    ...
    [
      ...
      {"assignedLicenses",
       case struct.assigned_licenses do
         nil -> nil
         items -> Enum.map(items, &GraphApi.Schema.Beta.AssignedLicense.to_map/1)
       end},
      {"passwordProfile",
       case struct.password_profile do
         nil -> nil
         val -> GraphApi.Schema.Beta.PasswordProfile.to_map(val)
       end},
