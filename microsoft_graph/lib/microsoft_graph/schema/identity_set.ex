...
defmodule MicrosoftGraph.Schema.IdentitySet do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          application: MicrosoftGraph.Schema.Identity.t() | nil,
          device: MicrosoftGraph.Schema.Identity.t() | nil,
          user: MicrosoftGraph.Schema.Identity.t() | nil
        }
    ...
    %__MODULE__{
      application:
        case map["application"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.Identity.from_map(val)
        end,
      device:
        case map["device"] do
          nil -> nil
    ...
    [
      {"application",
       case struct.application do
         nil -> nil
         val -> MicrosoftGraph.Schema.Identity.to_map(val)
       end},
      {"device",
