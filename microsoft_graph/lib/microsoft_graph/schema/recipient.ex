...
defmodule MicrosoftGraph.Schema.Recipient do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          email_address: MicrosoftGraph.Schema.EmailAddress.t() | nil
        }
    ...
    %__MODULE__{
      email_address:
        case map["emailAddress"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.EmailAddress.from_map(val)
        end
    }
  end
    ...
    [
      {"emailAddress",
       case struct.email_address do
         nil -> nil
         val -> MicrosoftGraph.Schema.EmailAddress.to_map(val)
       end}
    ]
