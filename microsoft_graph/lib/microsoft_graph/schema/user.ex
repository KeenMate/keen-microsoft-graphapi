...
defmodule MicrosoftGraph.Schema.User do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          assigned_licenses: [MicrosoftGraph.Schema.AssignedLicense.t()] | nil,
          password_profile: MicrosoftGraph.Schema.PasswordProfile.t() | nil,
    ...
    %__MODULE__{
      ...
      assigned_licenses:
        case map["assignedLicenses"] do
          nil -> nil
          items -> Enum.map(items, &MicrosoftGraph.Schema.AssignedLicense.from_map/1)
        end,
      password_profile:
        case map["passwordProfile"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.PasswordProfile.from_map(val)
        end,
    ...
    [
      ...
      {"assignedLicenses",
       case struct.assigned_licenses do
         nil -> nil
         items -> Enum.map(items, &MicrosoftGraph.Schema.AssignedLicense.to_map/1)
       end},
      {"passwordProfile",
       case struct.password_profile do
         nil -> nil
         val -> MicrosoftGraph.Schema.PasswordProfile.to_map(val)
       end},
