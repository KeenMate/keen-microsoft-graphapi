...
defmodule MicrosoftGraph.Schema.Location do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          address: MicrosoftGraph.Schema.PhysicalAddress.t() | nil
        }
  ...
  def from_map(map) when is_map(map) do
    %__MODULE__{
      ...
      address:
        case map["address"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.PhysicalAddress.from_map(val)
        end
    }
  end
    ...
    [
      ...
      {"address",
       case struct.address do
         nil -> nil
         val -> MicrosoftGraph.Schema.PhysicalAddress.to_map(val)
       end}
    ]
