...
defmodule MicrosoftGraph.Schema.Beta.File do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          hashes: MicrosoftGraph.Schema.Beta.Hashes.t() | nil
        }
  ...
  def from_map(map) when is_map(map) do
    %__MODULE__{
      ...
      hashes:
        case map["hashes"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.Beta.Hashes.from_map(val)
        end
    }
  end
    ...
    [
      ...
      {"hashes",
       case struct.hashes do
         nil -> nil
         val -> MicrosoftGraph.Schema.Beta.Hashes.to_map(val)
       end}
    ]
