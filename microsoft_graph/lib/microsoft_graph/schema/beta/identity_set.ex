...
defmodule MicrosoftGraph.Schema.Beta.IdentitySet do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          application: MicrosoftGraph.Schema.Beta.Identity.t() | nil,
          device: MicrosoftGraph.Schema.Beta.Identity.t() | nil,
          user: MicrosoftGraph.Schema.Beta.Identity.t() | nil
        }
    ...
    %__MODULE__{
      application:
        case map["application"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.Beta.Identity.from_map(val)
        end,
      device:
        case map["device"] do
          nil -> nil
    ...
    [
      {"application",
       case struct.application do
         nil -> nil
         val -> MicrosoftGraph.Schema.Beta.Identity.to_map(val)
       end},
      {"device",
