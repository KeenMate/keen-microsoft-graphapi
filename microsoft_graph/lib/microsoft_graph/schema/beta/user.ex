...
defmodule MicrosoftGraph.Schema.Beta.User do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          assigned_licenses: [MicrosoftGraph.Schema.Beta.AssignedLicense.t()] | nil,
          password_profile: MicrosoftGraph.Schema.Beta.PasswordProfile.t() | nil,
    ...
    %__MODULE__{
      ...
      assigned_licenses:
        case map["assignedLicenses"] do
          nil -> nil
          items -> Enum.map(items, &MicrosoftGraph.Schema.Beta.AssignedLicense.from_map/1)
        end,
      password_profile:
        case map["passwordProfile"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.Beta.PasswordProfile.from_map(val)
        end,
    ...
    [
      ...
      {"assignedLicenses",
       case struct.assigned_licenses do
         nil -> nil
         items -> Enum.map(items, &MicrosoftGraph.Schema.Beta.AssignedLicense.to_map/1)
       end},
      {"passwordProfile",
       case struct.password_profile do
         nil -> nil
         val -> MicrosoftGraph.Schema.Beta.PasswordProfile.to_map(val)
       end},
