...
defmodule MicrosoftGraph.Schema.Beta.DateTimeTimeZone do
  @moduledoc """
  Auto-generated schema for `microsoft.graph.dateTimeTimeZone`.
  """

  defstruct [:date_time, :time_zone]
