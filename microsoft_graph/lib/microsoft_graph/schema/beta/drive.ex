...
defmodule MicrosoftGraph.Schema.Beta.Drive do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          owner: MicrosoftGraph.Schema.Beta.IdentitySet.t() | nil,
          quota: MicrosoftGraph.Schema.Beta.Quota.t() | nil
        }
  ...
  def from_map(map) when is_map(map) do
    %__MODULE__{
      ...
      owner:
        case map["owner"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.Beta.IdentitySet.from_map(val)
        end,
      quota:
        case map["quota"] do
          nil -> nil
          val -> MicrosoftGraph.Schema.Beta.Quota.from_map(val)
        end
    }
  end
    ...
    [
      ...
      {"owner",
       case struct.owner do
         nil -> nil
         val -> MicrosoftGraph.Schema.Beta.IdentitySet.to_map(val)
       end},
      {"quota",
       case struct.quota do
         nil -> nil
         val -> MicrosoftGraph.Schema.Beta.Quota.to_map(val)
       end}
    ]
