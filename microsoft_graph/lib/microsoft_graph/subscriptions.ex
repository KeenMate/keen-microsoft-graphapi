defmodule MicrosoftGraph.Subscriptions do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, renewed} = MicrosoftGraph.Subscriptions.renew(sub["id"], %{
        "expirationDateTime" => "2025-05-01T00:00:00Z"
      })

      # Clean up
      :ok = MicrosoftGraph.Subscriptions.delete(sub["id"])
  """
  ...
  * `"latestSupportedTlsVersion"` — Minimum TLS version
  ...
  ## Examples
      ...
      MicrosoftGraph.Subscriptions.renew("sub-id", %{
        "expirationDateTime" => "2025-05-01T00:00:00Z"
      })
  """
