defmodule MicrosoftGraph.ViewTest do
  ...
  describe "__schema__/0" do
    test "returns the parent schema module" do
      assert UserSummary.__schema__() == MicrosoftGraph.Schema.User
    end
  end
  ...
  describe "from_map/1" do
    ...
    test "handles nested complex types in view" do
      ...
      assert %MicrosoftGraph.Schema.PasswordProfile{} = view.password_profile
  ...
  describe "compile-time validation" do
    test "raises CompileError for invalid field" do
      assert_raise CompileError, fn ->
        Code.compile_string("""
        defmodule MicrosoftGraph.ViewTest.BadView do
          use MicrosoftGraph.View,
            schema: MicrosoftGraph.Schema.User,
